...
def loadDatasetFromFolder(path="", batch_size=64, split_factor=0.8):
    ...
    transform_train = transforms.Compose([
        ...
        #transforms.Normalize([98.17989 / 255.0, 98.17989 / 255.0, 98.17989 / 255.0], 
        #                     [61.58394 / 255.0,61.58394 / 255.0, 61.58394 / 255.0])
...
def train(config_params_dict):
    ...
    project_name = config_params_dict['project_name']  
    orig_db_name = config_params_dict['orig_db_name']  
    model_architecture = config_params_dict['model_architecture']  
    backbone = config_params_dict['backbone']                    
    subset = config_params_dict['subset'] 
    n_epochs = config_params_dict['n_epochs']
    batch_size = config_params_dict['batch_size']  
    num_workers = config_params_dict['num_workers']  
    lRate = config_params_dict['lr']  
    wDecay = config_params_dict['weight_decay'] 
    early_stopping_threshold = config_params_dict['early_stopping_threshold']
    lr_scheduler_patience = config_params_dict['lr_scheduler_patience']
    split_factor = config_params_dict['split_factor'] 
...
if __name__ == "__main__":
    ...
    config_params_dict = {
        "root_path": "./HistShotV1/",
        #"root_path": "./movienet/movienet_shottypes_split/",
        "subfolder": "standardized",  
        "project_name": "ICPRAM2022",  # 
        "orig_db_name": "movienet_shottypes_split",       # HistShotV1   movienet_shottypes_split
    ...
    if (command == "train"):
        ...
        results_path = "./results/icpram2022/"
